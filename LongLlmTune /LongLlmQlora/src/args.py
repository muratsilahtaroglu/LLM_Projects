...
class TrainingArgs(TrainingArguments):
    ...
    lora_targets: List[str] = field(
        ...
        # config = LoraConfig(target_modules="all-linear", ...): TODO: Fast training de desteklemiyor sadece ["q_proj", "k_proj",
        # "v_proj", "o_proj","gate_proj", "up_proj", "down_proj"] verebiliyoruz. Diğer katmanlar için  lora_extra_params;'den eklenebilir
        #default_factory=lambda: ["q_proj", "k_proj", "v_proj", "o_proj","gate_proj", "up_proj", "down_proj"], vere
