...
def pad_nested_lists(lst, max_length, padding_value, padding_side="right"):
    """
    Recursively pad nested lists to a fixed length.

    Args:
        lst (list): The nested list to be padded.
        max_length (int): The maximum length of the list.
        padding_value (any): The value to pad the list with.
        padding_side (str, optional): The side to pad the list on, either "right" or "left". Defaults to "right".

    Returns:
        list: The padded list.
        list: The mask corresponding to the padded list, where 1 indicates a valid element and 0 indicates a padded element.
    """
